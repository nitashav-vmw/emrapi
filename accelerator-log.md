...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=nitashav-vmw&repo=emrapi",
  "namespace" : "nitashav",
  "projectName" : "EMRAPI",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->emrapi]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=nitashav-vmw&repo=emrapi'
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [new-namespace->nitashav, fiserv-accelerator->EMRAPI]
